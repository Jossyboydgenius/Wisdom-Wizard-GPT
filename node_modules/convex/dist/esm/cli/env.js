...
const envSet = new Command("set").arguments("<name> <value>").summary("Set a variable").description(
  "Set a variable: `npx convex env set NAME value`\nIf the variable already exists, its value is updated."
).configureHelp({ showGlobalOptions: true }).allowExcessArguments(false).action(async (name, value, _options, cmd) => {
...
const envRemove = new Command("remove").alias("rm").arguments("<name>").summary("Unset a variable").description(
...
export const env = new Command("env").summary("Set and view environment variables").description(
