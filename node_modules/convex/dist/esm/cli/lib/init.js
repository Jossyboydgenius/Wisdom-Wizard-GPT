...
import { createProjectProvisioningDevOrProd } from "./api.js";
...
export async function init(ctx, deploymentType = "prod", config) {
...
export async function finalizeConfiguration(ctx, functionsPath, deploymentType, url, wroteToGitIgnore) {
