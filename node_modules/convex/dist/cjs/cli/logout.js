...
const logout = new import_extra_typings.Command("logout").description("Log out of Convex on this machine").action(async () => {
  const ctx = import_context.oneoffContext;
  const globalConfigDirectory = (0, import_utils.rootDirectory)();
